1. Проверять соответствие партнёров требованиям ФЗ для обработки, передачи и хранения персональных данных, и оформить необходимые соглашения (как с пользователем, так и с партнёром).
